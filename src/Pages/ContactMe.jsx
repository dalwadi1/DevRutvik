...
const ContactMe = () => {
    return (
        <div className='min-h-screen max-w-7xl mx-auto px-6 sm:py-8'>
            <div className='grid sm:grid-cols-3 grid-cols-1 gap-1 sm:pt-25 pt-20'>
                <div className='flex flex-col items-start justify-center p-2'>
                    ...
                    <div className='sm:py-3 py-1'>
                        ...
                        <p className='text-white text-sm'>127 | Ameedhara Society Nana Varachha,Surat-395006</p>
                    </div>
                    <div className='sm:py-3 py-1'>
                        <h4 className='text-white text-sm'>Email</h4>
                        <p className='text-white text-sm'>parmarrutvik1807@gmail.com</p>
                    </div>
                    <div className='sm:py-3 py-1'>
                        <h4 className='text-white text-sm'>Mobile No</h4>
                        <p className='text-white text-sm'>+91 8141971488</p>
                    </div>
                </div>
                <div className='col-span-2 flex flex-col justify-center items-start p-2 pt-5'>
                    ...
                    <div className='p-2 w-full'>
                        ...
                        <div className='py-1'>
                            <button className="text-start cursor-pointer sm:px-5 sm:py-2 p-2 rounded-sm sm:font-medium sm:text-sm text-xs bg-white text-zinc-900">
                                SEND MESSAGE
                            </button>
                        </div>
                    </div>
