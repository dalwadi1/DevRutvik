...
const Skills = () => {
    return (
        <div className='min-h-screen max-w-7xl mx-auto px-6 sm:py-8'>
            ...
            <div className='grid sm:grid-cols-2 grid-cols-1 gap-5 py-5'>
                <div className='p-5 bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#312e81] rounded-sm border shadow-sm'>
                    <div className='flex items-center justify-between'>
                        <p className='text-white p-3 sm:text-2xl'>Html/css</p>
                ...
                <div className='p-5 bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#312e81] rounded-sm border shadow-sm'>
                    <div className='flex items-center justify-between'>
                        <p className='text-white p-3 sm:text-2xl'>Tailwind/css</p>
                ...
                <div className='p-5 bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#312e81] rounded-sm border shadow-sm'>
                    <div className='flex items-center justify-between'>
                        <p className='text-white p-3 sm:text-2xl'>JavaScript</p>
                ...
                <div className='p-5 bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#312e81] rounded-sm border shadow-sm'>
                    <div className='flex items-center justify-between'>
                        <p className='text-white p-3 sm:text-2xl'>React.js</p>
                ...
                <div className='p-5 bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#312e81] rounded-sm border shadow-sm'>
                    <div className='flex items-center justify-between'>
                        <p className='text-white p-3 sm:text-2xl'>Node.js</p>
                ...
                <div className='p-5 bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#312e81] rounded-sm border shadow-sm'>
                    <div className='flex items-center justify-between'>
                        <p className='text-white p-3 sm:text-2xl'>Laravel</p>
                        <Badge variant="outline" className='p-2 text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'>50%</Badge>
                    </div>
                    <Progress value={50} />
                </div>
